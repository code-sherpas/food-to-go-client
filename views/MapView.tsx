        ...
        <>
            <View style={styles.container}>
                ...
                <View>
                    ...
                    >
                        {(mapData != null) ? (mapData.map((marker: any) => { <Marker coordinate={{ latitude: marker.attributes.store.location.latitude, longitude: marker.attributes.store.location.latitude }} pinColor="#FF0000" /> })) : <></>}
                    </MapView> : <></>}
